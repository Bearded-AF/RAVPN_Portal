      ...
      <div class="main_container" style="background-color:#ff6000">
        ...
        <!-- /top navigation -->
			...
			<div class="right_col" role="main">
                ...
                @endif
								<div class="x_title">
									<h2 style="font-size:125%; padding-left:5px;">Add a new User </h2>
								...
								<div class="x_content">
									<br />
                  <form method="POST" action="{{ url('upload_user') }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="mt-4">
                          ...
                          <x-input id="employee_id" class="block mt-1 w-full" type="text" name="employee_id" :value="old('employee_id')" required autocomplete="e-id" />
                      </div>
                      ...
                      <div class="mt-4">
                          <x-label for="is_admin" value="{{ __('Admin Priviledge') }}" />
                          <select name="is_admin" class="block mt-1 w-full" required="required">
  													<option>No</option>
  													<option>Yes</option>
  												</select>
                      </div>
                      ...
                      <div class="mt-4">
  											...
  											<x-input id="profile_pic" class="block mt-1 w-full" type="file" name="profile_pic" required autocomplete="something" />
  										</div>
