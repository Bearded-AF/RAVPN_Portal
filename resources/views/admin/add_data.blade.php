      ...
      <div class="main_container" style="background-color:#ff6000">
        <div class="col-md-3 left_col" style="background-color:#ff6000">
          <div class="left_col scroll-view" style="background-color:#ff6000">
            <div class="navbar nav_title" style=" border: 0; background-color:#ff6000">
              <a href="{{url('home')}}" class="issue" style="padding:15px; padding-left:20px;" > <img style= "width:100%; height:auto;" src="images/blob1.png" alt="Logo"><span style="padding-left:20px; color:#fff; font-size: 200%"‍></span></a>
            </div>
        ...
        <!-- /top navigation -->
			...
			<div class="right_col" role="main">
                ...
                @endif
								<div class="x_title">
									<h2 style="font-size:125%; padding-left:5px;">Add a new RAVPN User <small></small></h2>
								...
								<div class="x_content">
									<br />
									<form class="form-horizontal form-label-left" action="{{url('upload_data')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row ">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="name" type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Name" required="required">
                    ...
                    <div class="form-group row ">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="id" type="text" class="form-control" placeholder="TW 220809" required="required">
											</div>
										</div>
                    ...
                    <div class="form-group row ">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="department" type="text" class="form-control" placeholder="" required="required">
											</div>
										</div>
                    ...
                    <div class="form-group row ">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="designation" type="text" class="form-control" placeholder="" required="required">
											</div>
										</div>
                    ...
                    <div class="form-group row ">
                      <label class="control-label col-md-3 col-sm-3 ">Email</label>
											<div class="col-md-9 col-sm-9 ">
                        <input name="email" type="email" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Email" required="required">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <select name="access" class="form-control" required="required">
                          <option>Choose Access Type</option>
                    ...
                    <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="date" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
												<script>
                    ...
                    <div class="form-group row">
											...
											<div class="col-md-9 col-sm-9 ">
												<textarea name="justification" class="form-control" rows="3" required="required" placeholder="State the purpose of your request"></textarea>
											</div>
										</div>
                    ...
                    <div class="form-group row ">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="validator" type="text" class="form-control" required="required" placeholder="">
											</div>
										</div>
                    ...
                    <div class="form-group row " style="padding-top:10px;">
											...
											<div class="col-md-9 col-sm-9 ">
												<input name="attachment" type="file" class="form-control" required="required">
											</div>
										</div>
